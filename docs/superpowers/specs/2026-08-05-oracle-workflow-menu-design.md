...
### 1. ไฟล์
commit `Oracle_Process_Interactive.html` เข้า repo root **ตามเดิมทุกไบต์ ห้ามแก้แม้แต่ตัวเดียว** — นี่คือสิ่งที่รับประกันความเหมือน และทำให้อัปเดตทีหลังเป็นแค่การทับไฟล์
...
2. ไฟล์ Oracle ที่ commit ต้องเหมือนต้นฉบับทุกไบต์ — เทียบ hash ก่อน/หลัง
3. Playwright:
